...
const DEFAULT_FACTOR_QUESTIONS: QuestionConfig[] = FACTOR_LABELS.map((label, i) => ({
    ...
    enabled: true,
    group: [
        "ลักษณะงาน", "ลักษณะงาน", "ลักษณะงาน", "ลักษณะงาน",                                           // 0-3
        "สภาพแวดล้อมในการทำงาน", "สภาพแวดล้อมในการทำงาน",                                               // 4-5
        "คุณภาพชีวิตในการทำงาน", "คุณภาพชีวิตในการทำงาน", "คุณภาพชีวิตในการทำงาน", "คุณภาพชีวิตในการทำงาน", // 6-9
        "ความสัมพันธ์กับเพื่อนร่วมงาน", "ความสัมพันธ์กับเพื่อนร่วมงาน", "ความสัมพันธ์กับเพื่อนร่วมงาน",   // 10-12
        "หัวหน้างาน", "หัวหน้างาน", "หัวหน้างาน", "หัวหน้างาน", "หัวหน้างาน",                           // 13-17
        "นโยบายและการบริหาร", "นโยบายและการบริหาร", "นโยบายและการบริหาร", "นโยบายและการบริหาร",           // 18-21
        "ผลประโยชน์และค่าตอบแทน", "ผลประโยชน์และค่าตอบแทน", "ผลประโยชน์และค่าตอบแทน",                   // 22-24
        "การประเมินผลและความก้าวหน้า", "การประเมินผลและความก้าวหน้า",
        "การประเมินผลและความก้าวหน้า", "การประเมินผลและความก้าวหน้า",                                     // 25-28
    ][i],
}));
