...
import { Heart, ChevronDown, ChevronUp, Download, BarChart3 } from "lucide-react";
...
function exportCSV(itemMeans: number[], filteredData: { engagement: number[] }[]) {
    ...
    const a = document.createElement("a"); a.href = url; a.download = "engagement_analysis.csv"; a.click();
